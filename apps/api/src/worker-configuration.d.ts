/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=WorkerEnv src/worker-configuration.d.ts` (hash: 9beb21ee8338c0ad5ac1e7ebf2b0fbf9)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "API_PORT" | "FRONTEND_ORIGIN" | "FRONTEND_URL" | "BACKEND_URL" | "EMAIL_PROVIDER" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_SECURE" | "SMTP_USER" | "SMTP_PASS" | "SMTP_FROM_EMAIL" | "SMTP_FROM_NAME" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_CALLBACK_URL">> {}
}
