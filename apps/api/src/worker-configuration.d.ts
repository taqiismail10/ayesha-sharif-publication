/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=WorkerEnv src/worker-configuration.d.ts` (hash: 0835d2d969f95e560368686f6d6a730f)
// Runtime types generated with workerd@1.20260911.1 2026-09-10 nodejs_compat
interface __BaseEnv_WorkerEnv {
	ASP_STORAGE: R2Bucket;
	asp_db: D1Database;
	DATABASE_URL: string;
	API_PORT: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DATABASE_URL" | "API_PORT" | "FRONTEND_ORIGIN" | "FRONTEND_URL" | "BACKEND_URL" | "EMAIL_PROVIDER" | "SMTP_HOST" | "SMTP_PORT" | "SMTP_SECURE" | "SMTP_USER" | "SMTP_PASS" | "SMTP_FROM_EMAIL" | "SMTP_FROM_NAME" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GOOGLE_CALLBACK_URL" | "NEXT_PUBLIC_API_BASE_URL" | "NEXT_PUBLIC_API_URL">> {}
}
