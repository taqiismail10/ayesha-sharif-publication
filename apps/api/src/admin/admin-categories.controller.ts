...
export class AdminCategoriesController {
  ...
  @Get()
  list() { return this.taxonomy.list("categories"); }

  @Post()
  create(@Body() body: unknown) { return this.taxonomy.create("categories", body); }

  @Put(":id")
  update(@Param("id") id: string, @Body() body: unknown) { return this.taxonomy.update("categories", id, body); }

  @Patch(":id/archive")
  archive(@Param("id") id: string) { return this.taxonomy.archive("categories", id); }
}
